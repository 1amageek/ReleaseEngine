...
Permit tapeout only when an immutable design has complete, applicable and sufficiently qualified evidence.

## Required functions

| Function | Required behavior | Priority |
|---|---|---:|
| Signoff profile | Define required axes and qualification thresholds for digital, analog and mixed-signal designs. | P0 |
...
| Signoff bundle | Produce an immutable, machine-verifiable approval or blocked decision packet. | P0 |
...
- Tapeout accepts only an approved SignoffBundle bound to the same final layout.
